...
const NewPoll = ({ setPolls, group, setShow }: Props) => {
  ...
  const submitHandler = async () => {
    ...
    const formData = { title, content, options, isMultiAnswer };
  ...
  return (
    <>
      <div className="w-[90%] lg:w-[40%] flex flex-col items-center gap-4  fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[100] bg-navbar rounded-xl py-6 px-8 shadow-xl animate-fade_third">
        ...
        />
        <h1 className="heading self-start text-2xl lg:text-3xl font-semibold text-gradient">
          Add a Poll
        </h1>
